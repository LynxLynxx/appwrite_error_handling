...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get general_query_limit_exceeded => '当前属性的查询限制已超过。禁止在单个属性上使用超过 100 个查询值';
  ...
  @override
  String get general_provider_failure => 'VCS（版本控制系统）提供程序无法处理请求。我们认为这是 VCS 提供程序的错误。请重试，或联系支持人员获取更多信息';

  @override
  String get project_unknown => '项目 ID 缺失或无效。请检查 X-Appwrite-Project 标头的值，以确保使用正确的项目 ID';
  ...
  @override
  String get project_template_default_deletion => '您无法删除默认模板。如果您尝试重置模板更改，您可以忽略此错误，因为它已经重置';

  @override
  String get general_unknown_origin => '请求来自未知来源。如果您信任此域，请在 Appwrite 控制台中将其列为受信任平台';
  ...
  @override
  String get rule_resource_not_found => '找不到资源。请检查 resourceId 和 resourceType 是否正确，或者资源是否实际存在';
  ...
  @override
  String get project_not_found => '找不到具有请求 ID 的项目。请检查 X-Appwrite-Project 标头的值，以确保使用正确的项目 ID';

  @override
  String get router_host_not_found => '主机不受信任。这可能是因为您尚未配置自定义域名。请先将自定义域名添加到您的项目，然后重试';

  @override
  String get general_not_implemented => '此方法尚未完全实现。如果您认为这是一个错误，请升级您的 Appwrite 服务器版本';

  @override
  String get project_already_exists => '具有请求 ID 的项目已存在。请尝试使用不同的 ID 或使用 unique() 生成唯一 ID';

  @override
  String get rule_already_exists => '域已被使用。请尝试使用不同的域';

  @override
  String get project_provider_disabled => '所选 OAuth 提供程序已禁用。您可以使用 Appwrite 控制台启用 OAuth 提供程序';
  ...
  @override
  String get general_protocol_unsupported => '无法使用当前协议完成请求。请检查 _APP_OPTIONS_FORCE_HTTPS 环境变量的值';

  @override
  String get general_codes_disabled => '此服务器上的邀请码已禁用。请联系服务器管理员';

  @override
  String get router_domain_not_configured => '_APP_DOMAIN、_APP_DOMAIN_TARGET 和 _APP_DOMAIN_FUNCTIONS 环境变量尚未配置。请在通过任何 IP 地址或除 localhost 之外的主机名访问 Appwrite 控制台之前配置域环境变量。此值可以是 203.0.113.0 等 IP 或 example.com 等主机名';

  @override
  String get general_usage_disabled => '未配置使用情况统计。请检查 Appwrite 服务器的 _APP_USAGE_STATS 环境变量的值';

  @override
  String get project_provider_unsupported => '所选 OAuth 提供程序不受支持。请查看 OAuth2 会话文档以了解支持的 OAuth 提供程序的完整列表';

  @override
  String get general_service_disabled => '请求的服务已禁用。您可以从 Appwrite 控制台中启用该服务';

  @override
  String get general_smtp_disabled => '您的 Appwrite 实例已禁用 SMTP。您可以在我们的文档中了解有关设置 SMTP 的更多信息';

  @override
  String get general_phone_disabled => '未配置电话提供程序。请检查 Appwrite 服务器的 _APP_SMS_PROVIDER 环境变量';
  ...
  @override
  String get password_personal_data => '您尝试使用的密码包含您的姓名、电子邮件、电话或 userID 的信息。为了您的安全，请选择不同的密码并重试';
  ...
  @override
  String get user_blocked => '当前用户已被阻止。您可以通过向 User API 的更新用户状态端点发送请求或在 Appwrite 控制台的 Auth 部分中取消阻止用户';
  ...
  @override
  String get user_auth_method_unsupported => '您所选的认证方式已被禁用或不支持。请在 Appwrite 控制面板检查支持的认证方式';
  ...
  @override
  String get collection_already_exists => '已存在该 ID 的集合，请使用不同的 ID 重新尝试，或使用 unique() 生成一个唯一 ID';

  @override
  String get document_already_exists => '已存在该 ID 的文档，请使用不同的 ID 重新尝试，或使用 unique() 生成一个唯一 ID';

  @override
  String get document_update_conflict => '远程文档比本地文档更新';

  @override
  String get attribute_already_exists => '已存在该 ID 的属性，请使用不同的 ID 重新尝试，或使用 unique() 生成一个唯一 ID';

  @override
  String get index_already_exists => '已存在该 ID 的索引，请使用不同的 ID 重新尝试，或使用 unique() 生成一个唯一 ID';
  ...
  @override
  String get storage_invalid_file_size => '文件大小无效或超过最大允许大小，请检查文件或 _APP_STORAGE_LIMIT 环境变量的值';

  @override
  String get storage_invalid_content_range => '内容范围无效，请检查 Content-Range 标头值';

  @override
  String get storage_invalid_appwrite_id => 'x-appwrite-id 标头值无效，请检查 x-appwrite-id 标头的值是否为有效 ID 而不是 unique()';
  ...
  @override
  String get storage_bucket_already_exists => '请求的 ID 已存在存储空间。请尝试使用不同的 ID，或使用 unique() 生成唯一 ID';
  ...
  @override
  String get provider_repository_not_found => '无法找到请求的 ID 的 VCS（版本控制系统）存储库。检查 ID 是否正确，以及它是否属于您提供的 installationId';
  ...
  @override
  String get function_runtime_unsupported => '请求的运行时已停用或不受支持。请检查 _APP_FUNCTIONS_RUNTIMES 环境变量的值';

  @override
  String get function_entrypoint_missing => '您的 Appwrite 函数缺少入口点。请在进行部署或更新入口点时指定入口点，方法是进入函数的设置 > 配置 > 入口点';
